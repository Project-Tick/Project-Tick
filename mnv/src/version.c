    ...
    int		colon)		// TRUE for ":intro"
{
	...
	"",
	N_("Please try Project Tick Projects!"),
	N_("type  :help projecttick<Enter> for information "),
	"",
	N_("type  :q<Enter>                to exit         "),
	N_("type  :help<Enter>  or  <F1>   for on-line help"),
	N_("type  :help version10<Enter>   for version info"),
    N_("type  :help license<Enter>     for license info"),
	NULL,
	"",
