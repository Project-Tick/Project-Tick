...
MNV is a greatly improved version of the good old UNIX editor Vi.  Many new
...
* Get a Windows executable from the mnv-win32-installer repository:
...
The User Manual reads like a book and is recommended to learn to use MNV.  See
":help user-manual".
...
"runtime/doc/uganda.txt" for details (do ":help uganda" inside MNV).
...
development team motivation to keep working on MNV!
...
If you would like to help make MNV better, see the CONTRIBUTING.md file.
...
to discuss them with MNV users and developers:
...
Most of MNV was created by Bram Moolenaar <Bram@mnv.org>, ":help Bram-Moolenaar"

Send any other comments, patches, flowers and suggestions to the mnv-dev
